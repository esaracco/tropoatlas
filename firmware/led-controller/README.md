...
Once flashed, the board connects to your Wi-Fi network and exposes a simple HTTP API on port **80**. TropoAtlas web applications (TropoAudio, TropoCine, TropoBiblio) use this API to illuminate the LEDs corresponding to the physical location of an item in your collection.
