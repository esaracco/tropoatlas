...
import { ButtonModal, HeaderButton, Search } from "../../index.js"
...
import { getPluginTerminology } from "@tropo/core"
...
export const Header = ({
  ...
  const activeFilters = [
    ...
    selected.creators?.length > 0 && {
      id: "creators",
      label: t(terminology.creators),
      onReset: () => setFilter("creators", []),
    },
    selected.categories?.length > 0 && {
      id: "categories",
      label: t(terminology.categories),
      ...
      >
        {showSearch ? (
          ...
          >
            <div className="flex-grow-1 header-search-container">
              <Search
                ...
                placeholder={t(terminology.searchPlaceholder || "Search")}
              />
            </div>
            <Button
              variant="secondary"
          ...
          <Container fluid className="d-flex align-items-center flex-nowrap">
            ...
            >
              <img src="/icon-180.png" height="36" width="36" alt="Logo" />
            </Navbar.Brand>
            <Navbar.Toggle
