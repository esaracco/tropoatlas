...
export const About = ({ plugin, appName }) => {
  ...
  return (
    <>
      <InfoModal
        title={t("About {{appName}} v{{version}}", {
          appName,
          version: appVersion,
        })}
        show={showAbout}
